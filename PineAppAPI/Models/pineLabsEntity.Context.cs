...
namespace PineAppAPI.Models
{
    ...
    public partial class PineLabsEntities : DbContext
    {
        public PineLabsEntities()
            : base("name=PineLabsEntities")
        {
        }
        ...
        public virtual ObjectResult<GetImageBySku_Result> GetImageBySku(string skuData)
        {
            var skuDataParameter = skuData != null ?
                new ObjectParameter("skuData", skuData) :
                new ObjectParameter("skuData", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetImageBySku_Result>("GetImageBySku", skuDataParameter);
        }
    
        public virtual ObjectResult<GetProductListWithFilter_Result> GetProductListWithFilter(Nullable<int> pageNo, Nullable<int> noOfrecord, string action, string value)
        {
            var pageNoParameter = pageNo.HasValue ?
                new ObjectParameter("pageNo", pageNo) :
                new ObjectParameter("pageNo", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetProductListWithFilter_Result>("GetProductListWithFilter", pageNoParameter, noOfrecordParameter, actionParameter, valueParameter);
        }
        ...
        public virtual ObjectResult<GetCategoryListWithFilter_Result> GetAllCategoryList()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetCategoryListWithFilter_Result>("GetAllCategoryList");
        }
        ...
        public virtual ObjectResult<Nullable<int>> GetCountProductListWithFilter(string action, string value)
        {
            var actionParameter = action != null ?
                new ObjectParameter("action", action) :
                new ObjectParameter("action", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("GetCountProductListWithFilter", actionParameter, valueParameter);
        }
